#!/usr/bin/env python3
"""Run and atomically persist the real Sdk V1 and V2 report sets."""
...
def fragment_environment(
    ...
    return environment | {
        "TYPE_BRIDGE_SDK_V2_PROOF_FRAGMENT": str(destination),
...
def main() -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="typebridge-sdk-v1-v2-") as value:
        ...
        print(f"Sdk V1/V2 artifact run failed: {error}", file=sys.stderr)
        return 1
