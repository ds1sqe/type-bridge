#!/usr/bin/env python3
"""Compare independently produced provider-free Workforce V5 canonical corpora."""
...
def compare(paths: dict[str, Path]) -> dict[str, Any]:
    ...
    return {
        ...
        "format": "typebridge.workforce-v5-provider-free-comparison/v1",
...
def main() -> int:
    ...
    try:
        ...
        print(f"workforce-v5 corpus rejected [{error.code}]: {error}", file=sys.stderr)
        return 1
