...
import compare_workforce_v5_corpora as corpora
import compare_workforce_v5_operational as operational

ROOT = Path(__file__).resolve().parents[2]
FORMAT = "typebridge.workforce-v5-producer-evidence/v1"
LIVE_FORMAT = "typebridge.workforce-v5-live-codec-evidence/v1"
CLEANUP_FORMAT = "typebridge.workforce-v5-cleanup-evidence/v1"
...
def main() -> int:
    ...
    try:
        ...
        print(f"workforce-v5 composition rejected [{code}]: {error}", file=sys.stderr)
        return 1
    return 0
