#!/usr/bin/env python3
"""Validate same-run deterministic proof fragments for sdk-v2 reports."""
...
PROOF_SCHEMA_RELATIVE = "tests/contracts/sdk_conformance/sdk-v2/proof-fragment-schema-v1.json"
ALLOWLIST_RELATIVE = "tests/contracts/sdk_conformance/sdk-v2/proof-fragment-allowlist-v1.json"
JOURNEY_RELATIVE = "tests/contracts/sdk_conformance/sdk-v2/journey-v2.json"
FRAGMENT_FORMAT = "typebridge.sdk-v2-proof-fragment/v1"
ALLOWLIST_FORMAT = "typebridge.sdk-v2-proof-fragment-allowlist/v1"
...
def main(argv: list[str] | None = None, *, root: Path = ROOT) -> int:
    ...
    try:
        ...
        print(f"sdk-v2 proof fragments rejected: {error}")
        return 1
    if args.observations_json:
        ...
        print(f"validated {len(observations)} sdk-v2 proof lanes for {args.binding}")
    return 0
