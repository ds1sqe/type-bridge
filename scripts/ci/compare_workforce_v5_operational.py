#!/usr/bin/env python3
"""Validate and compare four provider-free Workforce V5 operational artifacts."""
...
COMPARISON_FORMAT = "typebridge.workforce-v5-operational-comparison/v1"
BINDINGS = ("python", "node", "rust", "c")
TEST_IDS = {
    "python": "python.generated_workforce_v5_canonical_codec",
    "node": "node.generated_workforce_v5_canonical_codec",
    "rust": "rust_acceptance::generated_rust_workforce_v5_canonical_codec",
    "c": "c.generated_workforce_v5_canonical_codec",
}
TOP_LEVEL_KEYS = {
    "binding",
    "cancellation",
...
def main() -> int:
    ...
    try:
        ...
        print(
            f"workforce-v5 operational evidence rejected [{error.code}]: {error}", file=sys.stderr
        )
        return 1
