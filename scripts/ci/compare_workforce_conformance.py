#!/usr/bin/env python3
"""Validate and compare the Phase-1 Python, Node, and Rust workforce reports."""
...
CATALOG_RELATIVE = "tests/contracts/sdk_conformance/workforce-v1/catalog-v1.json"
JOURNEY_RELATIVE = "tests/contracts/sdk_conformance/workforce-v1/journey-v1.json"
REPORT_SCHEMA_RELATIVE = "tests/contracts/sdk_conformance/workforce-v1/report-schema-v1.json"
...
class ContractError(ValueError):
    """A stable fail-closed workforce contract rejection."""
...
def _validate_journey(value: Any) -> dict[str, dict[str, Any]]:
    ...
    if journey["fixture_id"] != "workforce-v1" or journey["version"] != 1:
...
def _validate_report(report: LoadedJson, contracts: Contracts) -> dict[str, Any]:
    ...
    if fixture["id"] != "workforce-v1" or _integer(fixture["version"], "fixture version") != 1:
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"workforce conformance rejected: {error}", file=sys.stderr)
        return 1
