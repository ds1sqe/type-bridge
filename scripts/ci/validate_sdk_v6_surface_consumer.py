...
RUST_CONSUMER_LOCK = ROOT / "tests/contracts/sdk-v6-rust-surface-Cargo.lock"
FORMAT = "typebridge.sdk-v6-surface-consumer/v1"
...
def consume(archive: Path, binding: str) -> dict[str, Any]:
    ...
    return {
        ...
        "cli-artifact-id": manifest["cli-artifact-id"],
...
def main() -> int:
    ...
    try:
        ...
        print(f"Sdk V6 surface consumer rejected [{code}]: {error}", file=sys.stderr)
        return 1
    return 0
