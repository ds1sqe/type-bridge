#!/usr/bin/env python3
"""Validate the source-bound Sdk V3 field-name identity artifact."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"Sdk V3 field-identity artifact rejected: {error}", file=sys.stderr)
        return 1
    if arguments.observation_json:
        sys.stdout.buffer.write(canonical_json_bytes(observation))
    else:
        print("validated Sdk V3 field-identity artifact")
    return 0
