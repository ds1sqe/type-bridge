#!/usr/bin/env python3
"""Validate and compare the Python, Node, Rust, and C workforce-v2 reports."""
...
CATALOG_RELATIVE = "tests/contracts/sdk_conformance/workforce-v2/catalog-v2.json"
JOURNEY_RELATIVE = "tests/contracts/sdk_conformance/workforce-v2/journey-v2.json"
REPORT_SCHEMA_RELATIVE = "tests/contracts/sdk_conformance/workforce-v2/report-schema-v2.json"
...
EXPECTED_SELECTED_PROOFS = (
    ...
    ("workforce.query.exact-subtypes", "direct_runtime", "exact_subtypes"),
    ("workforce.query.exact-subtypes", "remote_runtime", "exact_subtypes"),
    ("workforce.query.owner-iid-set", "direct_runtime", "owner_iid_set"),
    ("workforce.query.owner-iid-set", "remote_runtime", "owner_iid_set"),
    (
...
class ContractError(ValueError):
    """A stable fail-closed workforce-v2 contract rejection."""
...
def _validate_journey(value: Any) -> dict[str, dict[str, Any]]:
    ...
    if journey["fixture_id"] != "workforce-v2" or journey["version"] != 2:
...
def _validate_report(report: LoadedJson, contracts: Contracts) -> dict[str, Any]:
    ...
    if fixture["id"] != "workforce-v2" or _integer(fixture["version"], "fixture version") != 2:
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"workforce-v2 conformance rejected: {error}", file=sys.stderr)
        return 1
