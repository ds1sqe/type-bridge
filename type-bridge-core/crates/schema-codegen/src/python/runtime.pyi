...
class ModelBase:
    ...
    @classmethod
    def decode_create[ModelT: ModelBase](cls: type[ModelT], data: bytes) -> ModelT: ...
    def encode_snapshot(self) -> bytes: ...
    @classmethod
    def decode_snapshot[ModelT: ModelBase](cls: type[ModelT], data: bytes) -> ModelT: ...
...
class AttributeBase(ModelBase):
    ...
    def decode_attribute[AttributeT: AttributeBase](
        cls: type[AttributeT], data: bytes
    ) -> AttributeT: ...
...
class ReferenceBase:
    ...
    def decode_reference[ReferenceT: ReferenceBase](
        cls: type[ReferenceT], data: bytes
    ) -> ReferenceT: ...
