...
int main(int argc, char **argv) {
  ...
  if (!write_text_file(
          argv[3],
          "{\"binding\":\"c\",\"cancellation\":{\"code\":\"projected_codec_cancelled\",\"partial_output\":false},\"deadline\":{\"code\":\"projected_codec_deadline_exceeded\",\"partial_output\":false},\"diagnostic\":{\"category\":\"invalid_input\",\"code\":\"projected_record_schema_mismatch\",\"path\":[\"declared_schema_identity\"],\"payload_absent\":true},\"format\":\"typebridge.workforce-v5-operational-evidence/v1\",\"lifecycle\":{\"archive_closed\":true,\"builder_closed\":true,\"bytes_closed\":true,\"decoded_closed\":true,\"repeat_close\":true,\"sibling_usable\":true},\"resource_limits\":{\"depth_code\":\"projected_codec_depth_limit\",\"input_code\":\"projected_codec_input_limit\",\"member_code\":\"projected_codec_member_limit\",\"output_code\":\"projected_codec_output_limit\",\"partial_output\":false},\"test_id\":\"c.generated_workforce_v5_canonical_codec\"}"))
    return 64;
