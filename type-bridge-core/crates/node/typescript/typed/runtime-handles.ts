...
/** @internal Reject structurally forged public execution connections. */
...
/** @internal Retain an opaque native database without making it a root export. */
...
/** @internal Retain an opaque borrowed transaction without making it public. */
...
/** @internal Resolve database ownership for the typed match executor. */
...
/** @internal Resolve borrowed transaction ownership for the typed match executor. */
