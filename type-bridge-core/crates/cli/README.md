...
```bash
cargo install type-bridge-cli --version 2.2.1 --locked
type-bridge --help
...
2.2.1 and requires Rust 1.88+. Offline schema checking, generation, migration
...
[API documentation](https://docs.rs/type-bridge-cli/2.2.1) ·
