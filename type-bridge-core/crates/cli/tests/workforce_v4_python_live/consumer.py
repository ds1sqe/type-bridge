...
from workforce_v4_generated import Person, open_migration_catalog
...
def main() -> None:
    database_name = os.environ["TYPE_BRIDGE_WORKFORCE_V4_DATABASE"]
    ...
    initial_report = initial_plan.execute(database, "workforce-v4-python-initial")
    ...
    expand_plan.execute(database, "workforce-v4-python-expand")
    ...
    try:
        backfill_plan.execute(database, "workforce-v4-python-backfill-conflict")
