...
[`type_bridge_schema`](https://docs.rs/type-bridge-schema/2.2.1): load a schema
...
2.2.1 and requires Rust 1.88+. Resolution accepts the frozen TypeDB 3.11.5 and
...
[API documentation](https://docs.rs/type-bridge-schema/2.2.1) ·
