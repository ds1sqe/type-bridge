...
```toml
[dependencies]
type-bridge-schema = "2.2.2"
```

Use the staged APIs documented at
[`type_bridge_schema`](https://docs.rs/type-bridge-schema/2.2.2): load a schema
...
2.2.2 and requires Rust 1.88+. Resolution accepts the frozen TypeDB 3.11.5 and
...
[API documentation](https://docs.rs/type-bridge-schema/2.2.2) ·
