...
```toml
[dependencies]
type-bridge-schema-compat = "2.2.2"
```

Integrators should start with the released-syntax parsers and shadow-report
types in the [crate API](https://docs.rs/type-bridge-schema-compat/2.2.2). Treat
...
2.2.2, requires Rust 1.88+, and evaluates schemas against the TypeDB 3.12.1 V2
...
[API documentation](https://docs.rs/type-bridge-schema-compat/2.2.2) ·
