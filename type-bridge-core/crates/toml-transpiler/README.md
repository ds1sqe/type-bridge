...
```toml
[dependencies]
type-bridge-toml-transpiler = "2.2.2"
```
...
The crate is released in lockstep with TypeBridge 2.2.2 and requires Rust
...
[API documentation](https://docs.rs/type-bridge-toml-transpiler/2.2.2) ·
