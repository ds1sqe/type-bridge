...
```toml
[dependencies]
type-bridge-toml-transpiler = "2.2.1"
```
...
The crate is released in lockstep with TypeBridge 2.2.1 and requires Rust
...
[API documentation](https://docs.rs/type-bridge-toml-transpiler/2.2.1) ·
