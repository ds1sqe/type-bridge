...
```toml
[dependencies]
type-bridge-schema-migration = "2.2.0"
```

Start with the verified manifest and plan builders in the
[crate API](https://docs.rs/type-bridge-schema-migration/2.2.0). Execute only a
...
2.2.0 and requires Rust 1.88+. The shipped lowering profile is pinned to TypeDB
3.12.1; the wider runtime supports TypeDB 3.11.x–3.12.x where capabilities
allow.

[Repository](https://github.com/ds1sqe/type-bridge) ·
[API documentation](https://docs.rs/type-bridge-schema-migration/2.2.0) ·
