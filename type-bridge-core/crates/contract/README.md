...
```toml
[dependencies]
type-bridge-contract = "2.2.2"
```

Start with the [crate API](https://docs.rs/type-bridge-contract/2.2.2): create
...
[API documentation](https://docs.rs/type-bridge-contract/2.2.2) ·
