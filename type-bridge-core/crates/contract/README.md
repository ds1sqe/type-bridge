...
```toml
[dependencies]
type-bridge-contract = "2.2.1"
```

Start with the [crate API](https://docs.rs/type-bridge-contract/2.2.1): create
...
[API documentation](https://docs.rs/type-bridge-contract/2.2.1) ·
