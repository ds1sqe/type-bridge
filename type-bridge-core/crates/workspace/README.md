...
[crate API](https://docs.rs/type-bridge-workspace/2.2.2). Provide explicit
...
2.2.2 and requires Rust 1.88+. Each workspace selects one frozen
...
[API documentation](https://docs.rs/type-bridge-workspace/2.2.2) ·
