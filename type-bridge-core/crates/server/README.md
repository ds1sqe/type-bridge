...
```bash
cargo install type-bridge-server --version 2.2.1 --locked
...
declare `type-bridge-core-lib = "2.2.1"` directly:
...
The crate is released in lockstep with TypeBridge 2.2.1, requires Rust 1.88+,
and supports the retained TypeDB 3.11.x and 3.12.x provider bands.

[Repository](https://github.com/ds1sqe/type-bridge) ·
[API documentation](https://docs.rs/type-bridge-server/2.2.1) ·
