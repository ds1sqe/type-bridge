...
pub mod analyze {
    ...
    pub mod res {
        ...
        pub struct AnalyzedQuery {
            ...
            pub given: ::core::option::Option<analyzed_query::AnalyzedGiven>,
        }
...
pub mod database_manager {
    ...
    pub mod get {
        ...
        pub struct Res {
            #[prost(message, optional, tag = "1")]
            pub database: ::core::option::Option<super::super::Database>,
        }
    }
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct All {}
    ...
    pub mod all {
        ...
        pub struct Res {
            #[prost(message, repeated, tag = "1")]
            pub databases: ::prost::alloc::vec::Vec<super::super::Database>,
        }
    }
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct Contains {}
...
pub mod server_manager {
    ...
    pub mod get {
        ...
        pub struct Res {
            #[prost(message, optional, tag = "1")]
            pub server: ::core::option::Option<super::super::Server>,
        }
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Server {
    ...
    #[prost(message, optional, tag = "2")]
    pub replication_status: ::core::option::Option<server::ReplicationStatus>,
}
/// Nested message and enum types in `Server`.
pub mod server {
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct ReplicationStatus {
        #[prost(uint64, tag = "1")]
        pub id: u64,
        #[prost(enumeration = "replication_status::Role", optional, tag = "2")]
...
pub mod connection {
    ...
    pub mod open {
        ...
        pub struct Res {
            ...
            #[prost(message, optional, tag = "3")]
            pub servers_all: ::core::option::Option<
                super::super::server_manager::all::Res,
            >,
            #[prost(message, optional, tag = "4")]
            pub authentication: ::core::option::Option<
...
pub mod query {
    ...
    pub struct Req {
        ...
        pub query: ::prost::alloc::string::String,
        #[prost(message, optional, tag = "3")]
        pub given: ::core::option::Option<req::GivenRows>,
    }
    /// Nested message and enum types in `Req`.
    pub mod req {
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct GivenRows {
            ...
            #[prost(message, repeated, tag = "2")]
            pub rows: ::prost::alloc::vec::Vec<GivenRow>,
        }
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct GivenRow {
            #[prost(message, repeated, tag = "1")]
            pub entries: ::prost::alloc::vec::Vec<GivenEntry>,
        }
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct GivenEntry {
            #[prost(oneof = "given_entry::Entry", tags = "1, 2, 3")]
            pub entry: ::core::option::Option<given_entry::Entry>,
        }
        /// Nested message and enum types in `GivenEntry`.
        pub mod given_entry {
            #[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod type_db_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn servers_get(
            &mut self,
            request: impl tonic::IntoRequest<super::server_manager::get::Req>,
        ) -> std::result::Result<
            tonic::Response<super::server_manager::get::Res>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/typedb.protocol.TypeDB/servers_get",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("typedb.protocol.TypeDB", "servers_get"));
            self.inner.unary(req, path, codec).await
        }
        /// Server API
        pub async fn server_version(
            &mut self,
            request: impl tonic::IntoRequest<super::server::version::Req>,
        ) -> std::result::Result<
            tonic::Response<super::server::version::Res>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/typedb.protocol.TypeDB/server_version",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("typedb.protocol.TypeDB", "server_version"));
            self.inner.unary(req, path, codec).await
        }
        /// User Manager API
...
pub mod type_db_server {
    ...
    pub trait TypeDb: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn servers_get(
            &self,
            request: tonic::Request<super::server_manager::get::Req>,
        ) -> std::result::Result<
            tonic::Response<super::server_manager::get::Res>,
            tonic::Status,
        >;
        ...
        async fn server_version(
            &self,
            request: tonic::Request<super::server::version::Req>,
        ) -> std::result::Result<
            tonic::Response<super::server::version::Res>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/typedb.protocol.TypeDB/servers_get" => {
                    #[allow(non_camel_case_types)]
                    struct servers_getSvc<T: TypeDb>(pub Arc<T>);
                    impl<
                        T: TypeDb,
                    > tonic::server::UnaryService<super::server_manager::get::Req>
                    for servers_getSvc<T> {
                        type Response = super::server_manager::get::Res;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TypeDb>::servers_get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = servers_getSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/typedb.protocol.TypeDB/server_version" => {
                    #[allow(non_camel_case_types)]
                    struct server_versionSvc<T: TypeDb>(pub Arc<T>);
                    impl<
                        T: TypeDb,
                    > tonic::server::UnaryService<super::server::version::Req>
                    for server_versionSvc<T> {
                        type Response = super::server::version::Res;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TypeDb>::server_version(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
