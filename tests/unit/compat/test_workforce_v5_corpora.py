"""Fail-closed tests for provider-free Workforce V5 corpus comparison."""
...
SCRIPT = ROOT / "scripts/ci/compare_workforce_v5_corpora.py"
SPEC = importlib.util.spec_from_file_location("workforce_v5_corpora", SCRIPT)
...
def test_comparison_requires_exact_equal_nine_record_corpora(tmp_path: Path) -> None:
    ...
    assert result["format"] == "typebridge.workforce-v5-provider-free-comparison/v1"
