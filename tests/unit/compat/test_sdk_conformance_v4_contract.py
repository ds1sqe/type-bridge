"""Frozen contract checks for Sdk V4."""
...
CONTRACT_ROOT = ROOT / "tests/contracts/sdk_conformance/sdk-v4"
...
def test_v4_freezes_exact_administration_case_partition() -> None:
    catalog = _load(CONTRACT_ROOT / "catalog-v4.json")

    assert catalog["format"] == "typebridge.sdk-catalog/v4"
