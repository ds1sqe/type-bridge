"""Fail-closed tests for Workforce V5 measured-evidence composition."""
...
SPEC = importlib.util.spec_from_file_location(
    "workforce_v5_evidence_composer", CI / "compose_workforce_v5_evidence.py"
)
...
def test_composes_exact_assembler_input_from_measured_artifacts(tmp_path: Path) -> None:
    ...
    report = __import__("assemble_workforce_conformance_v5").assemble_report(
