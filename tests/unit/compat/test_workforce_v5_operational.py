"""Fail-closed tests for Workforce V5 operational evidence comparison."""
...
SCRIPT = ROOT / "scripts/ci/compare_workforce_v5_operational.py"
SPEC = importlib.util.spec_from_file_location("workforce_v5_operational", SCRIPT)
