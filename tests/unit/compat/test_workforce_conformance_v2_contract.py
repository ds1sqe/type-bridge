"""Frozen source-contract tests for the four-binding workforce-v2 journey."""
...
CONTRACT_ROOT = ROOT / "tests/contracts/sdk_conformance/workforce-v2"
...
def test_workforce_v2_report_schema_freezes_four_bindings_and_34_rows() -> None:
    ...
    assert fixture["properties"]["id"] == {"const": "workforce-v2"}
...
def test_workforce_v2_proof_fragment_is_same_run_source_bound_and_closed() -> None:
    ...
    assert properties["format"] == {"const": "typebridge.workforce-v2-proof-fragment/v1"}
    ...
    assert allowlist["format"] == "typebridge.workforce-v2-proof-fragment-allowlist/v1"
...
def test_workforce_v2_authored_dataset_is_deterministic_and_cleanup_reversed() -> None:
    journey = _load("journey-v2.json")

    assert journey["format"] == "typebridge.workforce-journey/v2"
    assert journey["fixture_id"] == "workforce-v2"
...
def test_workforce_v2_freezes_21_normalized_observations_without_runtime_identity() -> None:
    journey = _load("journey-v2.json")
