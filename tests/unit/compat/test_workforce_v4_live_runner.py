"""Persistence contract for the exact four-binding Workforce V4 runner."""
...
RUNNER_PATH = ROOT / "scripts/ci/run_workforce_v4_live.py"
SPEC = importlib.util.spec_from_file_location("workforce_v4_live_runner", RUNNER_PATH)
