...
class ModelStrategy(ABC):
    ...
    def _convert_value(self, value: Any, attr_class: type) -> LiteralValue:
        ...
        val_type_map = {str: "string", int: "long", float: "double", bool: "boolean"}
...
class EntityStrategy(ModelStrategy):
    ...
    def identify(self, instance: Entity) -> list[Constraint]:
        ...
        for field_name, attr_info in key_attrs.items():
            ...
            if value is None:
                raise ValueError(f"Key attribute '{field_name}' is None")
...
class RelationStrategy(ModelStrategy):
    ...
    def build_match_all(
        ...
        from type_bridge.query.ast import HasConstraint, MatchClause, RelationPattern
